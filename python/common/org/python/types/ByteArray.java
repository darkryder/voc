...
*/
    ...
    public org.python.Object __iadd__(org.python.Object other) {
        if (other instanceof org.python.types.Bytes || other instanceof org.python.types.ByteArray) return this.__add__(other);
    ...
    public org.python.Object __getitem__(org.python.Object index) {
        if (index instanceof org.python.types.Slice) {
            ...
            if (stop > this.value.length) stop = this.value.length;
